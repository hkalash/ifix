...
public class Image_Adapter_2 extends RecyclerView.Adapter<Image_Adapter_2.ViewHolder> {
    private List<Itemlist_image> itemList;
    private Context context;
    private Image_Adapter_2.ItemClickListener clickListener;
    ...
    public Image_Adapter_2(Context context, List<Itemlist_image> itemList) {
    ...
    @Override
    public Image_Adapter_2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_item_list, parent, false);
// set the view's size, margins, paddings and layout parameters
        Image_Adapter_2.ViewHolder vh = new Image_Adapter_2.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(Image_Adapter_2.ViewHolder holder, final int position) {
...
//        }
     ...
     //   File myImageFile = new File(uri.getPath());
      //  Picasso.get().load(API.Profile_Path + image_path)
        Picasso.get().load(API.Profile_Path+image_path)
    ...
    public void setClickListener(Image_Adapter_2.ItemClickListener itemClickListener) {
