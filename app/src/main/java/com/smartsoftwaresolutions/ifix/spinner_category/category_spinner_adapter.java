...
public class category_spinner_adapter extends BaseAdapter {

    private List<category_spinner> SpinnerList;
    private Context context;
    LayoutInflater inflter;

    public category_spinner_adapter(List<category_spinner> spinnerList, Context ctx) {
    ...
    public category_spinner getItem(int position) {
...
// we creat a view holder
       PayInfoHolder holder = new PayInfoHolder();
        ...
        category_spinner p =SpinnerList.get(position);
        // we read from the list and put it in the text view
        holder.country_id.setText(p.getCat_DI());
        holder.country_name.setText(p.getCat_Name());
