...
public class MyAdapter3 extends RecyclerView.Adapter<MyAdapter3.ViewHolder> {
    ...
    public MyAdapter3 (Context context,List<Itemlistobject2> items, @NonNull OnItemCheckListener onItemCheckListener) {
...
// set the view's size, margins, paddings and layout parameters
        MyAdapter3.ViewHolder vh = new MyAdapter3.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(final MyAdapter3.ViewHolder holder, final int position) {
        if (holder instanceof MyAdapter3.ViewHolder) {
